                ...
                foreach (JObject jsonObject in jsonArray)
                {
                    var output = new
                    {
                         ...
                         DaliyE2PKWH = new string[]
                         {
                            ...
                            FormatValue(jsonObject["in5kwh"]),
                            FormatValue(jsonObject["in6kwh"]),
                            FormatValue(jsonObject["in7kwh"]),
                            FormatValue(jsonObject["in8kwh"])
                         },
                         DaliyE2OKWH = new string[]
                         {
                            ...
                            FormatValue(jsonObject["out5kwh"]),
                            FormatValue(jsonObject["out6kwh"]),
                            FormatValue(jsonObject["out7kwh"]),
                            FormatValue(jsonObject["out8kwh"])
                         },
            ...
            var tableStructures = new Dictionary<string, List<Column>>
            {
                ...
                },
                {
                    "elemeter2", new List<Column>
                    {
                        ...
                        new Column { Name = "Ukwh5", Type = "float", IsNullable = true, Key = "", Comment = "组合有功5" },
                        new Column { Name = "Ukwh6", Type = "float", IsNullable = true, Key = "", Comment = "组合有功6" },
                        new Column { Name = "Ukwh7", Type = "float", IsNullable = true, Key = "", Comment = "组合有功7" },
                        new Column { Name = "Ukwh8", Type = "float", IsNullable = true, Key = "", Comment = "组合有功8" },
                        ...
                        new Column { Name = "PUkwh5", Type = "float", IsNullable = true, Key = "", Comment = "正有功J5" },
                        new Column { Name = "PUkwh6", Type = "float", IsNullable = true, Key = "", Comment = "正有功J6" },
                        new Column { Name = "PUkwh7", Type = "float", IsNullable = true, Key = "", Comment = "正有功J7" },
                        new Column { Name = "PUkwh8", Type = "float", IsNullable = true, Key = "", Comment = "正有功J8" },
                        ...
                        new Column { Name = "OUkwh5", Type = "float", IsNullable = true, Key = "", Comment = "反有功5" },
                        new Column { Name = "OUkwh6", Type = "float", IsNullable = true, Key = "", Comment = "反有功6" },
                        new Column { Name = "OUkwh7", Type = "float", IsNullable = true, Key = "", Comment = "反有功7" },
                        new Column { Name = "OUkwh8", Type = "float", IsNullable = true, Key = "", Comment = "反有功8" },
                        new Column { Name = "Nukwh", Type = "float", IsNullable = true, Key = "", Comment = "综合无功总电能" },
                        ...
                        new Column { Name = "Nukwh5", Type = "float", IsNullable = true, Key = "", Comment = "综合无功总5" },
                        new Column { Name = "Nukwh6", Type = "float", IsNullable = true, Key = "", Comment = "综合无功总6" },
                        new Column { Name = "Nukwh7", Type = "float", IsNullable = true, Key = "", Comment = "综合无功总7" },
                        new Column { Name = "Nukwh8", Type = "float", IsNullable = true, Key = "", Comment = "综合无功总8" },
                        ...
                        new Column { Name = "PNukwh5", Type = "float", IsNullable = true, Key = "", Comment = "正向无功5" },
                        new Column { Name = "PNukwh6", Type = "float", IsNullable = true, Key = "", Comment = "正向无功6" },
                        new Column { Name = "PNukwh7", Type = "float", IsNullable = true, Key = "", Comment = "正向无功7" },
                        new Column { Name = "PNukwh8", Type = "float", IsNullable = true, Key = "", Comment = "正向无功8" },
                        ...
                        new Column { Name = "ONukwh5", Type = "float", IsNullable = true, Key = "", Comment = "反向无功5" },
                        new Column { Name = "ONukwh6", Type = "float", IsNullable = true, Key = "", Comment = "反向无功6" },
                        new Column { Name = "ONukwh7", Type = "float", IsNullable = true, Key = "", Comment = "反向无功7" },
                        new Column { Name = "ONukwh8", Type = "float", IsNullable = true, Key = "", Comment = "反向无功8" },
                        new Column { Name = "AllUkva", Type = "float", IsNullable = true, Key = "", Comment = "总有用功率" },
                ...
                },
                {
                    "profit", new List<Column>
                    {
                        ...
                        new Column { Name = "in5kwh", Type = "float", IsNullable = true,  Key = "", Comment = "5" },
                        new Column { Name = "in5Price", Type = "float", IsNullable = true,  Key = "", Comment = "5价格" },
                        new Column { Name = "in6kwh", Type = "float", IsNullable = true,  Key = "", Comment = "6" },
                        new Column { Name = "in6Price", Type = "float", IsNullable = true,  Key = "", Comment = "6价格" },
                        new Column { Name = "in7kwh", Type = "float", IsNullable = true,  Key = "", Comment = "7" },
                        new Column { Name = "in7Price", Type = "float", IsNullable = true,  Key = "", Comment = "7价格" },
                        new Column { Name = "in8kwh", Type = "float", IsNullable = true,  Key = "", Comment = "8" },
                        new Column { Name = "in8Price", Type = "float", IsNullable = true,  Key = "", Comment = "8价格" },
                        ...
                        new Column { Name = "out5kwh", Type = "float", IsNullable = true,  Key = "", Comment = "放电5" },
                        new Column { Name = "out5Price", Type = "float", IsNullable = true,  Key = "", Comment = "放电5价" },
                        new Column { Name = "out6kwh", Type = "float", IsNullable = true,  Key = "", Comment = "放电6" },
                        new Column { Name = "out6Price", Type = "float", IsNullable = true,  Key = "", Comment = "放电6价" },
                        new Column { Name = "out7kwh", Type = "float", IsNullable = true,  Key = "", Comment = "放电7" },
                        new Column { Name = "out7Price", Type = "float", IsNullable = true,  Key = "", Comment = "放电7价" },
                        new Column { Name = "out8kwh", Type = "float", IsNullable = true,  Key = "", Comment = "放电8" },
                        new Column { Name = "out8Price", Type = "float", IsNullable = true,  Key = "", Comment = "放电8价" },
